...
{
    [HideInInspector] public readonly SyncList<UCE_HarvestingProfession> UCE_Professions = new SyncList<UCE_HarvestingProfession>();
    ...
    protected void Cmd_UCE_checkResourceNodeAccess(GameObject _UCE_selectedResourceNode)
    {
        ...
        else
        {
            ...
            {
                movement.NearestValidDestination(this.collider.ClosestPointOnBounds(transform.position));
            }
        }
    }
