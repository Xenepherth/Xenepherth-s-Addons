...
public partial class Database
{
    ...
    public void Connect_UCE_Warehouse()
    {
#if _MYSQL
    ...
    public void CharacterLoad_UCE_Warehouse(Player player)
    {
		...
		if (table.Count > 0) {
			foreach (List<object> row in table) {
				...
				if (slot < player.playerWarehouseStorageItems && ScriptableItem.All.TryGetValue(itemName.GetStableHashCode(), out template)) {
