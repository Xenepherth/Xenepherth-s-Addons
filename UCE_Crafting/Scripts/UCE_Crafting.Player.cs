...
public partial class Player
{
    ...
    [HideInInspector] public readonly SyncList<UCE_CraftingProfession> UCE_Crafts = new SyncList<UCE_CraftingProfession>();
    [HideInInspector] public readonly SyncList<string> UCE_recipes = new SyncList<string>();
            ...
            if (UCE_Crafting_CraftValidation(UCE_myRecipe, amount, boost))
            {
                ...
                for (int i = 1; i <= amount; i++)
                    ...
                    if (UnityEngine.Random.value <= successProbability)
                    {
                        ...
                        ((PlayerSkills)this.skills).skillExperience += UCE_myRecipe.skillExp;
